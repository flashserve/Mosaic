...
class ForwardContext:
    ...
    activation_memory_pool: Optional[Any] = None
    # P/O split for graph builder (DLLM models)
    prompt_length: Optional[int] = None
    output_length: Optional[int] = None
    # mask indices for gather-gemm optimization (DLLM models)
...
def set_forward_context(
    ...
    _forward_context = ForwardContext(
        ...
        activation_memory_pool=activation_memory_pool,
