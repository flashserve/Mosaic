...
class Processor:
    ...
    def process_inputs(
        ...
        if isinstance(params, SamplingParams):
            ...
            # Set prompt_length for P/O split in graph builder
            sampling_params.prompt_length = len(decoder_inputs["prompt_token_ids"])
            # Ensure output_length is set (fallback to gen_length if not provided)
            if sampling_params.output_length is None:
                sampling_params.output_length = sampling_params.gen_length
        else:
