...
class ModelConfig:
    ...
    def __post_init__(self) -> None:
        ...
        # Special case: DreamModel is a text generation model
        is_dream_model = "DreamModel" in architectures
        
        if self.runner_type == "generate" and not is_generative_model and not is_dream_model:
    ...
    def _get_default_runner_type(
        ...
        for arch in architectures:
            # Special case: DreamModel is a text generation model, not pooling
            # despite the "*Model" suffix that would normally indicate pooling
            if arch == "DreamModel":
                return "generate"
