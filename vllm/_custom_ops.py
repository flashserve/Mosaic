...
def fused_add_rms_norm_out(out: torch.Tensor, residual_out: torch.Tensor,
                           input: torch.Tensor, residual: torch.Tensor,
                           weight: torch.Tensor, epsilon: float) -> None:
    """New version with output buffers support"""
    torch.ops._C.fused_add_rms_norm_out(out, residual_out, input, residual, weight, epsilon)
