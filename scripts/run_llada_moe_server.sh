...
MODEL_DIR="${MODEL_DIR:-${LLADA_MOE_MODEL_DIR:-${MODEL_ROOT}/llada-moe-7b-a1b}}"
...
export LLADA_MOE_MODEL_DIR="${MODEL_DIR}"
...
export VLLM_VMM_CHUNK_SIZE="${VLLM_VMM_CHUNK_SIZE:-$((2 * 1024 * 1024))}"
