...
TORCH_LIBRARY_EXPAND(TORCH_EXTENSION_NAME, ops) {
  ...
  // New version with output buffers
  ops.def(
      "fused_add_rms_norm_out(Tensor! out, Tensor! residual_out, Tensor input, "
      "Tensor residual, Tensor weight, float epsilon) -> ()");
  ops.impl("fused_add_rms_norm_out", torch::kCUDA, &fused_add_rms_norm_out);
