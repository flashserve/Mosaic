// file: low_confidence.cu
// Fused Argmax + Softmax kernel for low_confidence remasking strategy
...
// 3. PyTorch 绑定部分
// =================================================================
std::vector<torch::Tensor> low_confidence_cuda(
    torch::Tensor logits
) {
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    m.def("low_confidence", &low_confidence_cuda, "Fused Argmax-Softmax for low_confidence remasking (CUDA)");
